package com.example.likeevideodownloader.util;

import static com.example.likeevideodownloader.util.Constants.downloadVideos;
import static com.example.likeevideodownloader.util.Utils.RootDirectoryFacebook;
import static com.example.likeevideodownloader.util.Utils.RootDirectoryInsta;
import static com.example.likeevideodownloader.util.Utils.RootDirectoryLikee;
import static com.example.likeevideodownloader.util.Utils.RootDirectoryMoz;
import static com.example.likeevideodownloader.util.Utils.RootDirectorySnapchat;
